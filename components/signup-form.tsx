...
export function SignupForm() {
  ...
  const handleGoogleSignup = () => {
    console.log("[v0] Google signup")
  }

  const handleMicrosoftSignup = () => {
    console.log("[v0] Microsoft signup")
  }
  ...
  return (
    <div className="relative w-full max-w-md">
      <div className="relative bg-white rounded-3xl shadow-xl p-8 sm:p-12">
        ...
        <p className="text-center text-gray-600 mb-8">Create your AgentFlow account</p>
        ...
        <form onSubmit={handleEmailSignup} className="space-y-4">
          ...
          <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg bg-gray-50/50">
            <div className="flex items-center gap-3">
              <Checkbox id="human" checked={isHuman} onCheckedChange={(checked) => setIsHuman(checked as boolean)} />
              <label htmlFor="human" className="text-sm font-medium text-gray-900 cursor-pointer">
                I am human
              </label>
            </div>
            <span className="text-xs text-gray-500">Friendly Captcha</span>
          </div>
